...
struct SiteUserController: SiteControllerUtils {
	...
	func registerRoutes(_ app: Application) throws {
		...
		let semiPrivateRoutes = getSemiPrivateRoutes(app).grouped(DisabledSiteSectionMiddleware(feature: .users))
		semiPrivateRoutes.get("profile", use: selfProfilePageHandler)
		semiPrivateRoutes.get("profile", "edit", use: selfProfileEditPageHandler)
		semiPrivateRoutes.get("profile", "edit", userIDParam, use: userProfileEditPageHandler)
		semiPrivateRoutes.get("profile", "username", "edit", use: selfUsernameEditPageHandler)
		semiPrivateRoutes.get("profile", "username", "edit", userIDParam, use: modUsernameEditPageHandler)
		semiPrivateRoutes.get("profile", "report", userIDParam, use: profileReportPageHandler)
		semiPrivateRoutes.get("directory", use: directoryPageHandler)
		semiPrivateRoutes.get("blocks", use: blocksPageHandler)
		semiPrivateRoutes.get("alertwords", use: alertMuteWordsPageHandler)
		semiPrivateRoutes.get("mutewords", use: alertMuteWordsPageHandler)
