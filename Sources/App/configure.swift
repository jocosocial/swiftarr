...
func configureLeaf(_ app: Application) throws {
	...
	app.leaf.tags["formatGroupText"] = try FormatPostTextTag(.group)
	...
	app.leaf.tags["groupTime"] = GroupTimeTag()
...
func configureMigrations(_ app: Application) throws {
	...
	app.migrations.add(CreateFriendlyGroupSchema(), to: .psql)
	app.migrations.add(CreateGroupParticipantSchema(), to: .psql)
	app.migrations.add(CreateGroupPostSchema(), to: .psql)
	app.migrations.add(CreateFriendlyGroupEditSchema(), to: .psql)
