...
func configureLeaf(_ app: Application) throws {
	...
	app.leaf.tags["formatChatGroupText"] = try FormatPostTextTag(.chatgroup)
	...
	app.leaf.tags["chatGroupTime"] = ChatGroupTimeTag()
...
func configureMigrations(_ app: Application) throws {
	...
	app.migrations.add(CreateFriendlyChatGroupSchema(), to: .psql)
	app.migrations.add(CreateChatGroupParticipantSchema(), to: .psql)
	app.migrations.add(CreateChatGroupPostSchema(), to: .psql)
	app.migrations.add(CreateFriendlyChatGroupEditSchema(), to: .psql)
