...
public enum ModeratorActionType: String, Codable {
	/// The moderator has created a post, but is posting as @moderator or @twitarrTeam. 'Post' could be a twarrt, forum post, or group post.
	case post
	...
	case markReviewed
	/// The moderator has locked a piece of content. Locking prevents the owner from modifying the content; locking a forum or group prevents new messages
	/// from being posted.
	case lock
