...
struct SiteUserController: SiteControllerUtils {
	...
	func registerRoutes(_ app: Application) throws {
		...
		privateRoutes.get("profile", use: selfProfilePageHandler).setUsedForPreregistration()
		privateRoutes.get("profile", "edit", use: selfProfileEditPageHandler).setUsedForPreregistration()
		privateRoutes.get("profile", "edit", userIDParam, use: userProfileEditPageHandler)
		privateRoutes.post("profile", "edit", use: userProfileEditPostHandler).setUsedForPreregistration()
		...
		privateRoutes.get("profile", "username", "edit", use: selfUsernameEditPageHandler).setUsedForPreregistration()
		privateRoutes.get("profile", "username", "edit", userIDParam, use: modUsernameEditPageHandler)
		privateRoutes.post("profile", "username", "edit", use: usernameEditPostHandler).setUsedForPreregistration()
