...
struct SiteAdminController: SiteControllerUtils {
	...
	var oauthClientIDParam = PathComponent(":oauth_client_id")
	...
	func registerRoutes(_ app: Application) throws {
		...
		privateTTRoutes.get("oauth", use: oauthClientsHandler)
		privateTTRoutes.get("oauth", "client", "create", use: oauthClientCreateHandler)
		privateTTRoutes.post("oauth", "client", "create", use: oauthClientCreatePostHandler)
		privateTTRoutes.get("oauth", "client", oauthClientIDParam, use: oauthClientViewHandler)
		privateTTRoutes.post("oauth", "client", oauthClientIDParam, "update", use: oauthClientUpdatePostHandler)
		privateTTRoutes.post("oauth", "client", oauthClientIDParam, "delete", use: oauthClientDeletePostHandler)
